...
---
**마지막 수정 날짜:** 2026-03-25 11:22

**수정 사항:** 
1. **브리핑 에이전트 주도성 강화**: "추천해줘"와 같은 모호한 요청에도 사용자에게 되묻지 않고, 최 최신 트렌드를 스스로 검색하여 즉시 추천 카드를 생성하도록 로직을 개선했습니다.
2. **Vision Agent 응답 최적화**: 사용자의 질문 의도에 따라 응답 구성을 분기(좌표 vs 설명)했습니다.
