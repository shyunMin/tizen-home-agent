...
---
**마지막 수정 날짜:** 2026-03-25 11:15

**수정 사항:** 
1. **Vision Agent 응답 최적화**: 위치/좌표 요청과 일반 화면 설명 요청을 구분하여, 의도에 꼭 필요한 정보(좌표 또는 설명)만 선택적으로 제공하도록 로직을 개선했습니다.
2. **테스트 가이드 업데이트**: 최신 모델과 응답 시나리오를 반영하여 README의 테스트 실행 로그 예시를 교체했습니다.
