...
---
**마지막 수정 날짜:** 2026-03-25 11:09

**수정 사항:** 
1. **Vision Agent 응답 최적화**: 사용자의 질문 의도에 따라 응답 구성을 분기했습니다.
    - 위치/좌표 요청 시: 전체 설명을 생략하고 **객체 좌표 및 클릭 포인트**만 간결하게 출력
    - 화면 설명 요청 시: 좌표를 생략하고 **전체 구성 및 콘텐츠** 위주로 친절하게 설명
2. **Visual Grounding 지원**: `vision_worker_node`에서 정규화 좌표(0-1000) 추출 기능을 안정화했습니다.
