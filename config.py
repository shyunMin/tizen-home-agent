...
TaskType = Literal["general_chat", "search", "device_control", "draw_ui", "briefing", "app_deploy", "youtube_play", "genui", "vision"]

class RouterResult(BaseModel):
    """Router 노드의 구조화된 출력."""
    # Vertex AI(Gemini) API의 JSON Schema 제약 사항(additionalProperties 미지원)에 
    # 대응하기 위해 추가 필드를 명시적으로 금지합니다.
    # 만약 다른 LLM 서비스로 전환 시 필요에 따라 수정하세요.
    model_config = ConfigDict(extra="forbid")
